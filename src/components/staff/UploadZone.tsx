...
export default function UploadZone({ onParsed, onError }: UploadZoneProps) {
  ...
  const processFile = async (file: File) => {
    ...
    // Simulate smooth processing progress bar
      ...
      >
        ...
        {loading ? (
          <div className="w-full max-w-xs space-y-4">
            ...
            <p className="text-sm text-gray-500 animate-pulse">Reading & validating data...</p>
          </div>
        ) : (
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <p className="text-white font-medium text-base">
                Drag and drop your file here, or <span className="text-emerald-400 underline">browse</span>
              </p>
